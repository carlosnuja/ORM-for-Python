...
def do (from_scratch):
    ...
    load_environment({'backend' : 'sqlalchemy', 'sqlalchemy.url' : 'mysql://root:perrodino18@localhost:3306/unitTest', 'sqlalchemy.pool_size' : 10 , 'sqlalchemy.max_overflow' : 10 , 'sqlalchemy.pool_timeout' : 30})
